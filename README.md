...
I enjoy building AI-powered applications, Android apps, IoT solutions, and full-stack web projects using **Python, TensorFlow, Keras, Scikit-learn, SQL, Java, Kotlin, Firebase, and Git**.

Currently, I'm exploring **Generative AI, Microsoft Azure AI, MLOps, and Cloud Computing**, while actively seeking **AI/ML and Software Engineering Internship** opportunities.

- 🤖 AI & Machine Learning Enthusiast
- 📊 Data Science & Analytics
- 📱 Android Developer
- 🌐 Full Stack Learner
- ☁️ Learning Azure AI & MLOps
...
<img src="https://skillicons.dev/icons?i=python,java,c,cpp,kotlin,php,html,css,js,mysql"/>
...
<img src="https://skillicons.dev/icons?i=tensorflow,firebase,git,github,githubactions,vscode"/>
...
|----------|-------------|------|
| 🧠 Deepfake Image Detection | CNN-based model for detecting manipulated images using Deep Learning. | Python, TensorFlow, Keras |
| ⚙️ Agile MLOps | End-to-end ML workflow with GitHub Actions and CI/CD practices. | Python, Scikit-learn |
| 📱 Mini Fitness Tracker | Android app with Firebase Authentication and fitness tracking. | Kotlin, Firebase |
| 🛒 IoT Smart Shopping Cart | Smart billing system using ESP32 and PHP backend. | ESP32, PHP |
...
- Microsoft – Generative AI on Azure
- Ethical Hacking Masterclass – Cydenium
- VR Development using Unity RT3D & Blender
- C Programming
- C++
- Data Structures
...
> *"Building intelligent software that solves real-world problems through AI, data, and innovation."*

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:6C2BD9,50:7C3AED,100:4F46E5&height=120&section=footer"/>
